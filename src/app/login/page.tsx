...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(37,99,235,0.16),transparent_45%)] px-4 py-10">
        ...
        <div className="flex-1 space-y-5">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl font-semibold tracking-tight text-slate-900">
              Secure lead operations for a fast-moving team.
            </h1>
            <p className="max-w-xl text-lg text-slate-600">
              Manage leads, track performance, and upload prospect lists with confidence from a polished, production-ready workspace.
            </p>
          </div>
        </div>

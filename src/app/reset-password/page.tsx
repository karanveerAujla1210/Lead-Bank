      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-8 rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.35)] backdrop-blur lg:flex-row lg:items-center lg:p-12">
        <div className="flex-1 space-y-5">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl font-semibold tracking-tight text-slate-900">Create a new password</h1>
            <p className="max-w-xl text-lg text-slate-600">Your reset link is valid. Set a strong new password below.</p>
          </div>
        </div>
